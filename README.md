...
2. **Install dependencies:**  
    bundle install  
    <br/>_(Note: The mysql2 gem requires MySQL client libraries to be installed on your system.)_
...
2. Database Setup (Minimal):  
    ...
    rails db:create  
    <br/>_(Note: No tables or migrations are needed for this proxy application's data storage.)_
...
1. Testing Callbacks Locally (Requires Tunneling):  
...
This will execute request specs (testing the API endpoints and their before_actions) and service specs (testing the CoingateService logic with mocked HTTP calls).
